...
public class SpookedParticleEffect extends SpriteBillboardParticle {
    ...
    SpookedParticleEffect(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, int fromColor, int toColor) {
        super(world, x, y, z);
    ...
    public void tick() {
        ...
        if (this.age++ >= this.maxAge) {
            ...
            this.setColor(ColorHelper.Argb.getRed(i) / 255.0F, ColorHelper.Argb.getGreen(i) / 255.0F, ColorHelper.Argb.getBlue(i) / 255.0F);
            this.setAlpha(ColorHelper.Argb.getAlpha(i) / 255.0F);
        }
    }
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            SpookedParticleEffect ominousSpawningParticle = new SpookedParticleEffect(clientWorld, d, e, f, g, h, i, -12210434, -1);
